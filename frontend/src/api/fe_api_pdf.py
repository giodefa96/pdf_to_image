...
def convert_pdf_to_image(file) -> dict[str, Any]:
    ...
    response = requests.post(url, files=files, verify=ca_cert_path, cert=(client_cert_path, client_key_path))
...
def get_status(task_id: str) -> dict[str, Any]:
    ...
    response = requests.get(url, verify=ca_cert_path, cert=(client_cert_path, client_key_path))
