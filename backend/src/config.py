...
class Settings:
    ...
    AZURE_STORAGE_QUEUE_CONNECTION_STRING: str = os.getenv("AZURE_STORAGE_QUEUE_CONNECTION_STRING")
    AZURE_STORAGE_QUEUE_NAME: str = os.getenv("AZURE_STORAGE_QUEUE_NAME")
